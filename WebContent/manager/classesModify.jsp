...
<body>
<div class="text2">
  <form id="form1" name="form1" method="post" action="sys_Update_classesManagement.action" onsubmit="return verInput();">
    <table width="662" border="0" align="center" class="word_darkGrey">
      <tr>
        <td>班级编号：</td>
        <td><s:property value="#session.cla.cla_id" /></td>
        <td align="center"><font color="#FF0000" size="-1"><div id="name_hint">班级编号不能修改</div></font></td>
      </tr>
      <tr>
        <td width="103">班级名称：</td>
        <td width="240"><label>
          <input type="text" name="claname" id="claname" onfocus="clearErrorMsg('num_hint')" onblur="number('num_hint')" value='<s:property value="#session.cla.cla_name" />' />
        </label></td>
      ...
      <tr>
        ...
        <td><label>
          <select name="dep" id="dep">
          	<s:if test='%{#session.cla.dep_id==1}'>
      ...
      <tr>
        <td colspan="2" align="center"><label>
          <input type="submit" name="button" id="button" class="btn_grey" value="修改班级信息" />
        </label></td>
        <td align="center">&nbsp;</td>
      </tr>
    </table>
