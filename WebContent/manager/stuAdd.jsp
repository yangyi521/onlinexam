...
<div class="text2">
  <form action="sys_Add_stuManagement.action" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return verInput();">
    <table width="662" border="0" align="center" class="word_darkGrey">
      ...
      <tr>
        ...
        <td><select name="dep" id="dep">
        	<s:iterator value="#session.deps" var="dep">
      ...
      <tr>
        <td colspan="2" align="center"><label>
          <input type="submit" name="button" id="button" class="btn_grey" value="增加学生" />
        </label>&nbsp;&nbsp;&nbsp;<a href="bulkStuAdd.jsp">批量导入学生</a></td>
        <td align="center">&nbsp;</td>
      </tr>
    </table>
  </form>
