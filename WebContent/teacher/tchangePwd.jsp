...
<body>
<div class="text2">
<form id="form1" name="form1" method="post" action='tea_Update_tpersonalInfo.action?method=changePwd&tea_id=<s:property value="#session.teacher.tea_id" />' onsubmit="return verInput()">
