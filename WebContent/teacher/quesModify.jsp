...
<body>
<div class="text2">
  <form id="form1" name="form1" method="post" action='tea_Update_quesBank.action?q_id=<s:property value="#session.quess.q_id" />&currentPage=0' onsubmit="return verInput();">
    <table width="462" border="0" align="center" class="word_darkGrey">
      ...
      <tr>
        <td width="90">题目：</td>
        <td width="376"><label>
          <textarea name="ques" id="ques" style="resize:none;"><s:property value="#session.quess.q_title" /></textarea>
        </label></td>
      ...
      <tr>
        <td>正确答案：</td>
        <td><label>
          <input type="text" name="ans" id="ans" onfocus="clearErrorMsg('ans_hint')" onblur="anscheck('ans_hint')" value='<s:property value="#session.quess.q_ans" />' />
        </label></td>
        <td><font color="#FF0000" size="-1"><div id="ans_hint"></div></font></td>
      </tr>
      <tr>
        <td colspan="3" align="center"><label>
          <input type="submit" name="button" id="button" class="btn_grey" value="修改试题" />
        </label></td>
      </tr>
    </table>
  </form>
