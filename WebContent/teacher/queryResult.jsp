...
<table width="90%" border="0" align="center" cellpadding="0"
		...
		<c:choose>
			<c:when test="${page.hasPrePage}">
				<a href="tea_Find_queryResult.action?tea_id=<s:property value="#session.teacher.tea_id" />&method=all&currentPage=1">首页</a> | 
				<a href="tea_Find_queryResult.action?tea_id=<s:property value="#session.teacher.tea_id" />&method=all&currentPage=${page.currentPage -1 }">上一页</a>
			</c:when>
			<c:otherwise>
							首页 | 上一页
						</c:otherwise>
